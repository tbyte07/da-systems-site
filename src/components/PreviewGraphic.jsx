...
export default function PreviewGraphic() {
  return (
    <div className="pg-wrap">
      <div className="pg-graphic">

        {/* ── Panel 1: Daten Architektur ── */}
        <div className="pg-panel pg-panel-1">
          <div>
        ...
        {/* ── Panel 2: Dashboard + AI Sidebar ── */}
        <div className="pg-panel pg-panel-2">
            ...
            <div className="pg-charts-row">
              ...
              <div className="pg-chart-card">
                ...
                <svg viewBox="0 0 120 60" fill="none" preserveAspectRatio="none" style={{ flex: 1 }}>
                  ...
                  <path d="M0 50 L20 40 L40 44 L60 28 L80 20 L100 15 L120 8 L120 60 L0 60 Z" fill="url(#pgLineGrad)" />
          ...
          <div className="pg-ai-sidebar">
            ...
            <div className="pg-chat-bubble-small pg-chat-bubble-small-user">Kosten?</div>
            <div className="pg-chat-bubble-small pg-chat-bubble-small-ai">Ad Spend: <strong style={{ color: '#8a95ff' }}>€1.6k</strong> — im Budget.</div>
        ...
        {/* ── Panel 3: KI Chat ── */}
        <div className="pg-panel pg-panel-3">
          <div>
